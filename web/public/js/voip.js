...
/*
      ...
      function doRegister(REG_realm,REG_impi,REG_impu,REG_password,REG_display_name){
        try {
            ...
            if (!o_impu || !o_impu.s_user_name || !o_impu.s_host) {
                txtRegStatus.innerHTML = "<b>[" + REG_impu + "] is not a valid Public identity</b>";
                btnRegister.disabled = false;
                return;
            }
      ...
      function sipCall(s_type ,NumberVal) {
          if (oSipStack && !oSipSessionCall && !tsk_string_is_null_or_empty(NumberVal)) {
              ...
              if (oSipSessionCall.call(NumberVal) != 0) {
                  ...
                  btnCallSTD_A.disabled = false;
                  btnCallSTD_B.disabled = false;
                  btnCallSTD_C.disabled = false;
      ...
      function sipHangUp() {
          if (oSipSessionCall) {
              ...
              if(activeNumber == StationA)
              {
                btnCallSTD_A.value = 'Call';
                btnCallSTD_A.disabled = false;

                ledSTD_A_1.setAttribute("class", "circleN");
                ledSTD_A_1.setAttribute("cx", "95.5");
                ledSTD_A_1.setAttribute("cy", "95.5");
                ledSTD_A_1.setAttribute("r", "81.5");
                ledSTD_A_1.setAttribute("style", "fill:#009425");

                ledSTD_A_2.setAttribute("class", "circleN");
                ledSTD_A_2.setAttribute("cx", "95.5");
                ledSTD_A_2.setAttribute("cy", "95.5");
                ledSTD_A_2.setAttribute("r", "66.3");
                ledSTD_A_2.setAttribute("style", "fill:#00691a");
              }

              if(activeNumber == StationB)
              {
                btnCallSTD_B.value = 'Call';
                btnCallSTD_B.disabled = false;

                ledSTD_B_1.setAttribute("class", "circleN");
                ledSTD_B_1.setAttribute("cx", "95.5");
                ledSTD_B_1.setAttribute("cy", "95.5");
                ledSTD_B_1.setAttribute("r", "81.5");
                ledSTD_B_1.setAttribute("style", "fill:#009425");

                ledSTD_B_2.setAttribute("class", "circleN");
                ledSTD_B_2.setAttribute("cx", "95.5");
                ledSTD_B_2.setAttribute("cy", "95.5");
                ledSTD_B_2.setAttribute("r", "66.3");
                ledSTD_B_2.setAttribute("style", "fill:#00691a");
              }

              if(activeNumber == StationD)
              {
                btnCallSTD_C.value = 'Call';
                btnCallSTD_C.disabled = false;

                ledSTD_C_1.setAttribute("class", "circleN");
                ledSTD_C_1.setAttribute("cx", "95.5");
                ledSTD_C_1.setAttribute("cy", "95.5");
                ledSTD_C_1.setAttribute("r", "81.5");
                ledSTD_C_1.setAttribute("style", "fill:#009425");

                ledSTD_C_2.setAttribute("class", "circleN");
                ledSTD_C_2.setAttribute("cx", "95.5");
                ledSTD_C_2.setAttribute("cy", "95.5");
                ledSTD_C_2.setAttribute("r", "66.3");
                ledSTD_C_2.setAttribute("style", "fill:#00691a");
              }

              if(activeNumber == StationD)
              {
                btnCallSTD_D.value = 'Call';
                btnCallSTD_D.disabled = false;

                ledSTD_D_1.setAttribute("class", "circleN");
                ledSTD_D_1.setAttribute("cx", "95.5");
                ledSTD_D_1.setAttribute("cy", "95.5");
                ledSTD_D_1.setAttribute("r", "81.5");
                ledSTD_D_1.setAttribute("style", "fill:#009425");

                ledSTD_D_2.setAttribute("class", "circleN");
                ledSTD_D_2.setAttribute("cx", "95.5");
                ledSTD_D_2.setAttribute("cy", "95.5");
                ledSTD_D_2.setAttribute("r", "66.3");
                ledSTD_D_2.setAttribute("style", "fill:#00691a");
              }
          }
      }
      ...
      function onDivCallCtrlMouseMove(evt) {
          try { // IE: DOM not ready
              if (tsk_utils_have_stream()) {
                  btnCallSTD_A.disabled = (!tsk_utils_have_stream() || !oSipSessionRegister || !oSipSessionRegister.is_connected());
                  btnCallSTD_B.disabled = (!tsk_utils_have_stream() || !oSipSessionRegister || !oSipSessionRegister.is_connected());
                  btnCallSTD_C.disabled = (!tsk_utils_have_stream() || !oSipSessionRegister || !oSipSessionRegister.is_connected());
      ...
      function uiOnConnectionEvent(b_connected, b_connecting) { // should be enum: connecting, connected, terminating, terminated
          ...
          btnAnnouncement.disabled = !b_connected && !b_connecting;
          btnCallSTD_A.disabled = !(b_connected && tsk_utils_have_webrtc() && tsk_utils_have_stream());
          btnCallSTD_B.disabled = !(b_connected && tsk_utils_have_webrtc() && tsk_utils_have_stream());
          btnCallSTD_C.disabled = !(b_connected && tsk_utils_have_webrtc() && tsk_utils_have_stream());
              ...
              case 'i_new_call':
                  {
                      if (oSipSessionCall) {
                          ...
                          if(activeNumber == StationA)
                          {
                            btnCallSTD_A.value = 'Answer';
                            btnCallSTD_A.disabled = false;

                            ledSTD_A_1.setAttribute("class", "circle2");
                            ledSTD_A_1.setAttribute("cx", "95.5");
                            ledSTD_A_1.setAttribute("cy", "95.5");
                            ledSTD_A_1.setAttribute("r", "81.5");
                            ledSTD_A_1.setAttribute("style", "fill:#ad0800");

                            ledSTD_A_2.setAttribute("class", "circle1");
                            ledSTD_A_2.setAttribute("cx", "95.5");
                            ledSTD_A_2.setAttribute("cy", "95.5");
                            ledSTD_A_2.setAttribute("r", "66.3");
                            ledSTD_A_2.setAttribute("style", "fill:#fc0f03");
                            txtBuff = "STATION A";
                          }

                          if(activeNumber == StationB)
                          {
                            btnCallSTD_B.value = 'Answer';
                            btnCallSTD_B.disabled = false;

                            ledSTD_B_1.setAttribute("class", "circle2");
                            ledSTD_B_1.setAttribute("cx", "95.5");
                            ledSTD_B_1.setAttribute("cy", "95.5");
                            ledSTD_B_1.setAttribute("r", "81.5");
                            ledSTD_B_1.setAttribute("style", "fill:#ad0800");

                            ledSTD_B_2.setAttribute("class", "circle1");
                            ledSTD_B_2.setAttribute("cx", "95.5");
                            ledSTD_B_2.setAttribute("cy", "95.5");
                            ledSTD_B_2.setAttribute("r", "66.3");
                            ledSTD_B_2.setAttribute("style", "fill:#fc0f03");
                            txtBuff = "STATION B";
                          }

                          if(activeNumber == StationC)
                          {
                            btnCallSTD_C.value = 'Answer';
                            btnCallSTD_C.disabled = false;

                            ledSTD_C_1.setAttribute("class", "circle2");
                            ledSTD_C_1.setAttribute("cx", "95.5");
                            ledSTD_C_1.setAttribute("cy", "95.5");
                            ledSTD_C_1.setAttribute("r", "81.5");
                            ledSTD_C_1.setAttribute("style", "fill:#ad0800");

                            ledSTD_C_2.setAttribute("class", "circle1");
                            ledSTD_C_2.setAttribute("cx", "95.5");
                            ledSTD_C_2.setAttribute("cy", "95.5");
                            ledSTD_C_2.setAttribute("r", "66.3");
                            ledSTD_C_2.setAttribute("style", "fill:#fc0f03");
                            txtBuff = "STATION C";
                          }
                          ...
                          if(activeNumber == StationD)
                          {
                            ...
                            ledSTD_D_1.setAttribute("class", "circle2");
                            ledSTD_D_1.setAttribute("cx", "95.5");
                            ledSTD_D_1.setAttribute("cy", "95.5");
                            ledSTD_D_1.setAttribute("r", "81.5");
                            ledSTD_D_1.setAttribute("style", "fill:#ad0800");

                            ledSTD_D_2.setAttribute("class", "circle1");
                            ledSTD_D_2.setAttribute("cx", "95.5");
                            ledSTD_D_2.setAttribute("cy", "95.5");
                            ledSTD_D_2.setAttribute("r", "66.3");
                            ledSTD_D_2.setAttribute("style", "fill:#fc0f03");
                            txtBuff = "STATION D";
                          }

                          txtCallStatus.innerHTML = "<i>SOS ALERT from [<b>" + txtBuff + "</b>]</i>";
                      }
                      break;
                  }
