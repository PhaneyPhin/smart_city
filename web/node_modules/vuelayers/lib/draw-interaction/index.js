          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                instanceOf(source, Vector, "Source \"".concat(this.source, "\" doesn't exists in the identity map."));
                instanceOf(source.getFeaturesCollection(), Collection, "Source \"".concat(this.source, "\" doesn't provide features collection."));
