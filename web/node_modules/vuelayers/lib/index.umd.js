...
(function (global, factory) {
	...
	*/
	...
	var find_1 = function (it) {
	  var own = it.find;
	  return it === ArrayPrototype$6 || (it instanceof Array && own === ArrayPrototype$6.find) ? find : own;
	};
	...
	function isNumeric(value) {
	  return !isNaN(_parseFloat$3(value)) && globIsFinite(value);
	}
	...
	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$1(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$1(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	function _objectSpread$1(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context7; forEach$2(_context7 = ownKeys$2(source$$1, true)).call(_context7, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context8; forEach$2(_context8 = ownKeys$2(source$$1)).call(_context8, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	function createImageStyle(vlStyle) {
	  ...
	  if (!isEmpty$1(vlStyle.imageSrc) || !isEmpty$1(vlStyle.image)) {
	    ...
	    imageStyle = _objectSpread$1({}, vlStyle, {
	  ...
	  imageStyle = _objectSpread$1({}, imageStyle, {
	...
	function createTextStyle(vlStyle) {
	  ...
	  var font = filter$2(_context6 = ['normal', fontSize, vlStyle.textFont]).call(_context6, function (x) {
	    return !!x;
	  }).join(' ');
	...
	var reduce$1 = entryVirtual('Array').reduce;

	var ArrayPrototype$8 = Array.prototype;

	var reduce_1 = function (it) {
	  var own = it.reduce;
	  return it === ArrayPrototype$8 || (it instanceof Array && own === ArrayPrototype$8.reduce) ? reduce$1 : own;
	};
	...
	function makeWatchers(props, watcherFactory) {
	  return reduce$3(props).call(props, function (hash, prop) {
	...
	function extractChildren(slots) {
	  ...
	  return reduce$3(_context = keys$3(slots)).call(_context, function (all, name) {
	...
	function _objectSpread$2(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$3(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$3(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	var arcgisSource = {
	  ...
	  computed: {
	    ...
	    allParams: function allParams() {
	      return _objectSpread$2({}, this.cleanExtParams, {
	        LAYERS: this.layers,
	        FORMAT: this.format,
	  ...
	  watch: _objectSpread$2({}, makeWatchers(['layers', 'format', 'dpi', 'transparent', 'gdbVersion', 'mapScale', 'rotation', 'historicMoment'], function (prop) {
	    return function (value) {
	...
	***************************************************************************** */
	...
	function multiMergeDescriptors() {
	  ...
	  return reduce$3(_context = slice$2(args).call(args, 1)).call(_context, function (dest, src, i) {
	        ...
	        return regenerator.wrap(function _callee$(_context5) {
	          while (1) {
	            switch (_context5.prev = _context5.next) {
	              case 0:
	                _context5.next = 2;
	                return this.instanceFactoryCall(this.olObjIdent, bind$2(_context3 = this.createOlObject).call(_context3, this));

	              case 2:
	                this._olObject = _context5.sent;
	                this._olObject[VM_PROP] || (this._olObject[VM_PROP] = []);

	                if (!includes$4(_context4 = this._olObject[VM_PROP]).call(_context4, this)) {
	...
	var geometry$1 = {
	  ...
	  methods: {
	    ...
	    createOlObject: function () {
	      ...
	      function createOlObject() {
	        return _createOlObject.apply(this, arguments);
	      }

	      return createOlObject;
	    }(),
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 2:
	                ...
	                initializeSource(source$$1, this.id);
	...
	function _objectSpread$3(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$4(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$4(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var imageSource = {
	  mixins: [source$1],
	  props: {
	    crossOrigin: String,
	...
	var FORCED$6 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || SLOPPY_METHOD$1;
	...
	function _objectSpread$4(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; forEach$2(_context2 = ownKeys$5(source$$1, true)).call(_context2, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context3; forEach$2(_context3 = ownKeys$5(source$$1)).call(_context3, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var layer = {
	...
	*/
	...
	function _objectSpread$5(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; forEach$2(_context2 = ownKeys$6(source$$1, true)).call(_context2, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context3; forEach$2(_context3 = ownKeys$6(source$$1)).call(_context3, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var tileSource = {
	...
	function _objectSpread$6(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$7(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$7(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var vectorSource = {
	...
	function _objectSpread$7(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$8(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$8(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	var computed = {
	  ...
	  allParams: function allParams() {
	    return _objectSpread$7({}, this.cleanExtParams, {
	      LAYERS: this.layers,
	      STYLES: this.styles,
	...
	var methods = {
	  ...
	  getFeatureInfoUrl: function getFeatureInfoUrl(coordinate, resolution, projection) {
	    ...
	    params = _objectSpread$7({}, this.allParams, {}, params);
	    return this.$source.getGetFeatureInfoUrl(coordinate, resolution, projection, params);
	  }
	};

	var watch = _objectSpread$7({}, makeWatchers(['layers', 'version', 'styles', 'transparent', 'format', 'bgColor', 'time'], function (prop) {
	  return function (value) {
	    prop = prop.toUpperCase();
	...
	function _objectSpread$8(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$9(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$9(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	...
	function _objectSpread$9(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$a(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$a(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$4 = {
	...
	function _objectSpread$a(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context3; forEach$2(_context3 = ownKeys$b(source$$1, true)).call(_context3, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context4; forEach$2(_context4 = ownKeys$b(source$$1)).call(_context4, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	        ...
	        return regenerator.wrap(function _callee$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                _context2.next = 2;
	                return this.getInstance(this.source);

	              case 2:
	                source$$1 = _context2.sent;
	                instanceOf(source$$1, source.Vector, "Source \"".concat(this.source, "\" doesn't exists in the identity map."));
	                instanceOf(source$$1.getFeaturesCollection(), ol.Collection, "Source \"".concat(this.source, "\" doesn't provide features collection."));
	...
	function _objectSpread$b(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$c(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$c(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	  ...
	  this.subscribeTo(allChanges, function (_ref2) {
	    ...
	    _this3.$nextTick(function () {
	      if (prop === 'id') {
	        ...
	        _this3.$emit('update:properties', _objectSpread$b({}, _this3.properties, _defineProperty({}, prop, value)));
	      }
	    });
	  });
	}
	...
	function _objectSpread$c(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context3; forEach$2(_context3 = ownKeys$d(source$$1, true)).call(_context3, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context4; forEach$2(_context4 = ownKeys$d(source$$1)).call(_context4, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$9 = {
	  name: 'vl-graticule',
	  mixins: [cmp, useMapCmp, projTransforms],
	  props: {
	...
	function _objectSpread$e(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$f(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$f(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$c = {
	  name: 'vl-style-icon',
	  mixins: [imageStyle],
	  props: {
	...
	function _objectSpread$f(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context3; forEach$2(_context3 = ownKeys$g(source$$1, true)).call(_context3, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context4; forEach$2(_context4 = ownKeys$g(source$$1)).call(_context4, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	...
	var script$h = {
	  ...
	  methods: {
	    ...
	    mount: function mount() {
	      ...
	      this.$nextTick(bind$2(_context = this.updateSize).call(_context, this));
	      this.subscribeAll();
	    },
	  ...
	  watch: _objectSpread$f({}, makeWatchers(['keyboardEventTarget', 'loadTilesWhileAnimating', 'loadTilesWhileInteracting', 'moveTolerance', 'pixelRatio', 'renderer', 'maxTilesLoading'], function () {
	    return function () {
	      this.scheduleRecreate();
	    };
	  }), {
	  ...
	  created: function created() {
	    ...
	    forEach$2(_context2 = this._interactionsCollection).call(_context2, function (interaction$$1) {
	...
	var script$i = {
	  ...
	  methods: {
	    ...
	    fit: function fit(geometryOrExtent) {
	      ...
	      return new promise$5(function (resolve) {
	        _this2.$view.fit(geometryOrExtent, _objectSpread$g({}, options, {
	...
	function _objectSpread$h(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; forEach$2(_context2 = ownKeys$i(source$$1, true)).call(_context2, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context3; forEach$2(_context3 = ownKeys$i(source$$1)).call(_context3, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	 * @vueProto
	...
	function _objectSpread$i(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; forEach$2(_context5 = ownKeys$j(source$$1, true)).call(_context5, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context6; forEach$2(_context6 = ownKeys$j(source$$1)).call(_context6, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$t = {
	  ...
	  computed: {
	    layerFilter: function layerFilter() {
	      ...
	      return isArray$3(this.layers) ? function (layer$$1) {
	        ...
	        return includes$4(_context = _this.layers).call(_context, getLayerId(layer$$1));
	      } : this.layers;
	    }
	  },
	  methods: {
	    ...
	    mount: function mount() {
	      ...
	      forEach$2(_context2 = this.features).call(_context2, this.select);
	    },
	  ...
	  watch: _objectSpread$i({
	    features: {
	      ...
	      handler: function handler(features) {
	        ...
	        forEach$2(features).call(features, function (feature) {
	          feature = initializeFeature(_objectSpread$i({}, feature));

	          _this3.select(feature);
	        }); // unselect non-matched features


	        forEach$2(_context3 = difference(this.getFeatures(), features, function (a, b) {
	          return getFeatureId(a) === getFeatureId(b);
	        })).call(_context3, bind$2(_context4 = this.unselect).call(_context4, this));
	      }
	    },
	    featuresDataProj: {
	      deep: true,
	...
	function subscribeToInteractionChanges$2() {
	  ...
	  this.subscribeTo(events, function (evt) {
	    _this4.$nextTick(function () {
	      _this4.$emit(evt.type, evt.feature);
	    });
	  });
	}
	...
	function _objectSpread$j(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; forEach$2(_context2 = ownKeys$k(source$$1, true)).call(_context2, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context3; forEach$2(_context3 = ownKeys$k(source$$1)).call(_context3, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	/**
	        ...
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 2:
	                source$$1 = _context.sent;
	                instanceOf(source$$1, source.Source, "Source \"".concat(this.source, "\" doesn't exists in the identity map."));
	...
	function _objectSpread$k(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; forEach$2(_context5 = ownKeys$l(source$$1, true)).call(_context5, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context6; forEach$2(_context6 = ownKeys$l(source$$1)).call(_context6, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$D = {
	  ...
	  computed: {
	    ...
	    dataFormat: function dataFormat() {
	      ...
	      return this.instanceFactoryCall(this.dataFormatIdent, bind$2(_context2 = this.formatFactory).call(_context2, this));
	    }
	  },
	  methods: {
	    /**
	  ...
	  watch: _objectSpread$k({
	    features: {
	      ...
	      handler: function handler(features) {
	        ...
	        forEach$2(features).call(features, function (feature) {
	          feature = initializeFeature(_objectSpread$k({}, feature));
	        ...
	        forEach$2(_context3 = difference(this.getFeatures(), features, function (a, b) {
	          return getFeatureId(a) === getFeatureId(b);
	        })).call(_context3, bind$2(_context4 = this.removeFeature).call(_context4, this));
	      }
	    }
	...
	function _objectSpread$l(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; forEach$2(_context2 = ownKeys$m(source$$1, true)).call(_context2, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context3; forEach$2(_context3 = ownKeys$m(source$$1)).call(_context3, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$G = {
	  name: 'vl-source-wms',
	...
	function _objectSpread$m(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$n(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$n(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$H = {
	  name: 'vl-source-wmts',
	  mixins: [tileSource],
	  props: {
	...
	function _objectSpread$n(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context; forEach$2(_context = ownKeys$o(source$$1, true)).call(_context, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context2; forEach$2(_context2 = ownKeys$o(source$$1)).call(_context2, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var index_umd = _objectSpread$n({}, VueLayers, {
	  olExt: olExt,
	  rxExt: rxExt
	});
