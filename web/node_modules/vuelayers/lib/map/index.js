...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context3; _forEachInstanceProperty(_context3 = ownKeys(source, true)).call(_context3, function (key) { _defineProperty(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context4; _forEachInstanceProperty(_context4 = ownKeys(source)).call(_context4, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
/**
...
var script = {
  ...
  methods: {
    ...
    mount: function mount() {
      ...
      this.$nextTick(_bindInstanceProperty(_context = this.updateSize).call(_context, this));
      this.subscribeAll();
    },
  ...
  created: function created() {
    ...
    _forEachInstanceProperty(_context2 = this._interactionsCollection).call(_context2, function (interaction) {
...
function _objectSpread$1(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context2; _forEachInstanceProperty(_context2 = ownKeys$1(source, true)).call(_context2, function (key) { _defineProperty(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context3; _forEachInstanceProperty(_context3 = ownKeys$1(source)).call(_context3, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
/**
...
var script$1 = {
  ...
  methods: {
    ...
    fit: function fit(geometryOrExtent) {
      ...
      return new _Promise(function (resolve) {
        _this2.$view.fit(geometryOrExtent, _objectSpread$1({}, options, {
