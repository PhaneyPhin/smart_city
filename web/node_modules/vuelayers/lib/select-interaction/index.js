...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; _forEachInstanceProperty(_context5 = ownKeys(source, true)).call(_context5, function (key) { _defineProperty(target, key, source[key]); }); } else if (_Object$getOwnPropertyDescriptors) { _Object$defineProperties(target, _Object$getOwnPropertyDescriptors(source)); } else { var _context6; _forEachInstanceProperty(_context6 = ownKeys(source)).call(_context6, function (key) { _Object$defineProperty(target, key, _Object$getOwnPropertyDescriptor(source, key)); }); } } return target; }
var script = {
  ...
  computed: {
    layerFilter: function layerFilter() {
      ...
      return _Array$isArray(this.layers) ? function (layer) {
        ...
        return _includesInstanceProperty(_context = _this.layers).call(_context, getLayerId(layer));
      } : this.layers;
    }
  },
  methods: {
    ...
    mount: function mount() {
      ...
      _forEachInstanceProperty(_context2 = this.features).call(_context2, this.select);
    },
  ...
  watch: _objectSpread({
    features: {
      ...
      handler: function handler(features) {
        ...
        })).call(_context3, _bindInstanceProperty(_context4 = this.unselect).call(_context4, this));
      }
    },
    featuresDataProj: {
      deep: true,
