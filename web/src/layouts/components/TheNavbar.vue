...
<div class="relative">
	<div class="vx-navbar-wrapper">
		<vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
            ...
            <feather-icon class="xl:inline-flex hidden  cursor-pointer mr-1" icon="MenuIcon" @click.stop="opensidebar"></feather-icon>
            <!-- <feather-icon class="cursor-pointer mr-1" icon="MenuIcon" @click.stop="$emit('fullscreen')"></feather-icon> -->
