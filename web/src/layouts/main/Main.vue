...
<template>
    <fullscreen ref="fullscreen" @change="fullscreenChange" class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <the-customizer
            ...
            />
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/logo.png')" title="SMART CITY" parent=".layout--main" />
        ...
        <div id="content-area" :class="[contentAreaClass, {'show-overlay': bodyOverlay}]">
            ...
            <div class="content-wrapper">
                ...
                <the-navbar :navbarColor="navbarColor" :class="[{'text-white': isNavbarDark && !isThemeDark}, {'text-base': !isNavbarDark && isThemeDark}]" @fullscreen="toggle()" />
